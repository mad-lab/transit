...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.globalNTerminusLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Ignore N-Terminus %:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.globalNTerminusLabel.Wrap( -1 )
		bSizer1621.Add( self.globalNTerminusLabel, 0, wx.ALL, 5 )
		
		self.globalCTerminusLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Ignore C-Terminus %:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.globalNTerminusText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"0", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer1721.Add( self.globalNTerminusText, 0, wx.ALL, 5 )
		
		self.globalCTerminusText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"0", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.gumbelLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Gumbel Options", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.gumbelSampleLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Samples", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.gumbelSampleLabel.Wrap( -1 )
		bSizer16.Add( self.gumbelSampleLabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.gumbelBurninLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Burn-In", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.gumbelBurninLabel.Wrap( -1 )
		bSizer16.Add( self.gumbelBurninLabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.gumbelTrimLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Trim", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.gumbelTrimLabel.Wrap( -1 )
		bSizer16.Add( self.gumbelTrimLabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.gumbelReadLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Minimum Read", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.gumbelReadLabel.Wrap( -1 )
		bSizer16.Add( self.gumbelReadLabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.gumbelRepLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Replicates", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.gumbelSampleText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"10000", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer17.Add( self.gumbelSampleText, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
		
		self.gumbelBurninText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"500", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer17.Add( self.gumbelBurninText, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
		
		self.gumbelTrimText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"1", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.gumbelReadChoice = wx.Choice( self.m_scrolledWindow1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, gumbelReadChoiceChoices, 0 )
		...
		self.gumbelRepChoice = wx.Choice( self.m_scrolledWindow1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, gumbelRepChoiceChoices, 0 )
		...
		self.gumbelButton = wx.Button( self.m_scrolledWindow1, wx.ID_ANY, u"Run Gumbel", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.hmmRepLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Replicates", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.hmmRepLabel.Wrap( -1 )
		bSizer162.Add( self.hmmRepLabel, 1, wx.ALL, 5 )
		
		self.hmmLoessCheck = wx.CheckBox( self.m_scrolledWindow1, wx.ID_ANY, u"LOESS Correction", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		hmmRepChoiceChoices = [ u"TTRMean", u"Sum", u"Mean" ]
		self.hmmRepChoice = wx.Choice( self.m_scrolledWindow1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, hmmRepChoiceChoices, 0 )
		self.hmmRepChoice.SetSelection( 0 )
		bSizer172.Add( self.hmmRepChoice, 0, wx.ALL|wx.EXPAND, 5 )
		
		self.hmmLoessPrev = wx.Button( self.m_scrolledWindow1, wx.ID_ANY, u"Plot LOESS", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.hmmButton = wx.Button( self.m_scrolledWindow1, wx.ID_ANY, u"Run HMM", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.resamplingLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Resampling Options", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.resamplingSampleLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Samples", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.resamplingSampleLabel.Wrap( -1 )
		bSizer161.Add( self.resamplingSampleLabel, 1, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.resamplingNormLabel = wx.StaticText( self.m_scrolledWindow1, wx.ID_ANY, u"Normalization", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.resamplingSampleText = wx.TextCtrl( self.m_scrolledWindow1, wx.ID_ANY, u"10000", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.resamplingNormChoice = wx.Choice( self.m_scrolledWindow1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, resamplingNormChoiceChoices, 0 )
		...
		self.resamplingLoessCheck = wx.CheckBox( self.m_scrolledWindow1, wx.ID_ANY, u"Correction for Genome Positional Bias", wx.DefaultPosition, wx.DefaultSize, 0 )
		resamplingSection.Add( self.resamplingLoessCheck, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.resamplingLoessPrev = wx.Button( self.m_scrolledWindow1, wx.ID_ANY, u"Plot LOESS fit", wx.DefaultPosition, wx.DefaultSize, 0 )
		resamplingSection.Add( self.resamplingLoessPrev, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.resamplingHistCheck = wx.CheckBox( self.m_scrolledWindow1, wx.ID_ANY, u"Generate Resampling Histograms", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.resamplingAdaptiveCheck = wx.CheckBox( self.m_scrolledWindow1, wx.ID_ANY, u"Adaptive Resampling (faster)", wx.DefaultPosition, wx.DefaultSize, 0 )
		resamplingSection.Add( self.resamplingAdaptiveCheck, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.resamplingButton = wx.Button( self.m_scrolledWindow1, wx.ID_ANY, u"Run Resampling", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.gumbelProgress = wx.Gauge( self.m_scrolledWindow1, wx.ID_ANY, 20, wx.DefaultPosition, wx.DefaultSize, wx.GA_HORIZONTAL|wx.GA_SMOOTH )
